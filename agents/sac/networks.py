...
class CriticNetwork(nn.Module):
    def __init__(self, beta, input_dims, n_actions, fc1_dims=32, fc2_dims=32,
...
class ValueNetwork(nn.Module):
    def __init__(self, beta, input_dims, fc1_dims=32, fc2_dims=32,
...
class ActorNetwork(nn.Module):
    def __init__(self, alpha, input_dims, max_action, fc1_dims=32,
                 fc2_dims=32, n_actions=2, name='actor', chkpt_dir='tmp/sac'):
